...
export function buildApexCopilotSystemPrompt(skill: ApexCopilotSkill) {
  return [
    ...
    '- Treat English as the primary product language unless the user or UI toggle asks for Portuguese.',
    ...
    '- Suggested actions may be small chat chips or next-step buttons only after the assistant answer; cards are secondary only.',
