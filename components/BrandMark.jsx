// BrandMark.jsx — ConstructAI SVG brand mark
// tone="amber" for dark login surface, tone="blue" for light app sidebar
export default function BrandMark({ size = 48, tone = 'amber' }) {
